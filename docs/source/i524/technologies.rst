...
178. Public Cloud: Amazon SNS
     ...
     According to :cite:`sns-blog`SNS system architecture consists of
     four elements: (1) Topics, (2) Owners, (3) Publishers, and (4)
     Subscribers. Topics are events or access points that identifies the
     subject of the event and can be accessed by an unique
     identifier(URI). Owners create topics and control all access to the
     topic and define the corressponding permission for each
     ...
     in the topic, and delivers the message to each and every one of them.
