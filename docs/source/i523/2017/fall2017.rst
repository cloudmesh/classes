...
.. note:: This class ends on Dec 15 and not earlier. Residential
   ...
   you achieve your best we strongly advise to attend and give with
...
Logistic, Theory, Practice, Writing and put in bullet form what you have done
...
The format of the notebook is very specific and must follow these
rules:
...
.. warning:: degree seeking students have preference to take this
             ...
             enroll. IF space permits only than auditing and non
...
#. For non degree students and students that audit the class an
   ...
   be accessible during the semester. 
...
following time according to the information provided by the
registrar.
...
Residential Students:
    ...
    additional times are required, they have to be done on
    ...
    * Fri 3-4pm (Saber, Miao in Smith Research Center)
    ...
    Residential students can also use the online student meeting
    times. However, in that case online students will be served
    first. It is probably good to check into the zoom meeting and
    identify if the TA has time. They will be in zoom.
...
Online Students:
   ...
   * Wed 5-6 PM EST   (Juliette, no meeting notes for this meeting time, 
   ...
   If a meeting is needed with Gregor, this is done upon appointment
   Tue-Thu 10am - 2:30pm. TAs will figure out if a meeting is
   needed. Please prepare your questions ahead of time, and place them
   in Piazza first.

   Online students can also use the residential student meeting
   times. However, in that case residential students will be served
   first. It is probably good to check if the TA is free. They will be
   in zoom.
