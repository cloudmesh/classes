...
* Oct 2, 9am. Paper 1 due (Graded)

* Oct 2, 9am. Computer Setup due for Big Data Completed (pass/fail)

  * Linux Computer  or Linux VM on Virtual box
  * Raspberry Pi 3
  * ES8266 (only suitable for IoT)
...
Online Studenst:
    ...
    Please use the following doodle to identify times:

    * https://doodle.com/poll/gym73n8cy789vmw5
